...
#define   EV_Desfogue_on     output_bit(PIN_B3,1)
#define   EV_Desfogue_off    output_bit(PIN_B3,0)
#define   EV_Paso_on         output_bit(PIN_B2,1)
#define   EV_Paso_off        output_bit(PIN_B2,0)
...
void main()
{
   ...
   if(Ajuste>10)
      Ajuste=0;
   Ajusten=read_eeprom(14);//Ganancia2=read_eeprom(15);
   delay_ms(20);
   if(Ajusten>10)
      Ajusten=0;
