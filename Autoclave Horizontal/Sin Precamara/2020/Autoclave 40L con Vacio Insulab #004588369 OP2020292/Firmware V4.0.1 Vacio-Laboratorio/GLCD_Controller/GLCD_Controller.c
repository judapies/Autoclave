...
int8 iconoGrande[11]={22,62,25,24,58,64,23,28,20,46,79};
int8 iconoPeque[11]={18,61,34,33,57,63,32,38,19,17,78};
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------    
   ...
   if(PresionPreCamara>280 || PresionCamara>350){
      conteoPresion++;
      if((!DesfogueSuave && PresionPreCamara>280) || PresionCamara>350){
         if(conteoPresion>=10)
            AlarmaPresion=ON;  
      }
   }else{
