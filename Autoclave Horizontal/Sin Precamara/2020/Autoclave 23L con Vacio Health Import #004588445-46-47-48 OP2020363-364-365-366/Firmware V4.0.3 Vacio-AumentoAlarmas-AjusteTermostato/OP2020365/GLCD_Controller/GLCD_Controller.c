...
int8 Setpoint=0,Opcion=1,Opcion2=1,tiempo_esterilizacion=0,tiempo_secado=0,tiempoImpresion=0,cicloVisto=0,cicloVisualizado=0,j=0,vacioTest=17;
...
void main(){
   ...
   ApagaSalidas();
   TiempoVacio=360; 
   Sensor[0].Gain=105.66;
   Sensor[1].Gain=105.66;
   Imprime=10;
