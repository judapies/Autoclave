...
int8 h=0,l=0,Ajuste=0,Ajusten=0,MediaMovil=20,TTrampa=0,n=0;
...
int8 Control=0,tiemporecta=0,Controlando=0,ActivaImpresion=1,timpresion=2,CalculoImpresion=0;
int8 Menu=0, unidad=1,i=0,CiclosL=0,CiclosH=0,CicloSeleccionado=0;
int8 Setpoint=0,Opcion=1,tiempo_esterilizacion=0,tiempo_secado=0,tiempoImpresion=0;
...
int8 y=0;
int16 t_exhaust=0;
int8 Year=18,Mess=9,Dia=13,Hora=0,Minuto=0,Segundo=0,dow=0;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      if(visual==1)
      {
         ...
         {
            if(Opcion==7)
               {strcpy(Menus.Letra,"Prueba Componentes");
               displayMenu(Menus.Letra,0,10,1,1);}
            else
               {strcpy(Menus.Letra,"Prueba Componentes");
               displayMenu(Menus.Letra,0,10,0,1);}
            ...
            if(Opcion==8)
               {strcpy(Menus.Letra,"Ajustar Fecha/Hora");
               displayMenu(Menus.Letra,0,19,1,1);}
            else
               {strcpy(Menus.Letra,"Ajustar Fecha/Hora");
               displayMenu(Menus.Letra,0,19,0,1);}
      ...
      if(DOWN){
       ...
       if(RIGHT){
         if(Flanco1 == 0){
            Flanco1 = 1;delay_ms(30);Menu=Opcion+1;Opcion=1;glcd_fillscreen(OFF);visual=1;
            DiaTx=Dia;
            MesTx=Mess;
            YearTx=Year;
            HoraTx=Hora;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      if(Menu==4){ // Menu de Instrumental Suave     
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------    
 ...
 //_--------------------------------------------------------------------------------------------------------------------------------------------------------
      if(Menu==5){ // Menu de textil e instrumental     
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      if(Menu==6){ // Menu de Proceso Personalizado
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      if(Menu==8){ // Menu de Prueba de Componentes
      PruebaEstados=ON;
         if(Opcion>8)
         {Opcion=1;}
         if(Opcion<1)
      ...
      if(Opcion<7){
         ...
         if(UP)//Si oprime hacia arriba
         {  
            Opcion--;delay_ms(1);glcd_fillscreen(OFF);
         }
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      ...
      {Opcion=2;}
         ...
         if(LEFT){
            ...
            Opcion=1;
            glcd_fillscreen(OFF);visual=1;
            write_eeprom(40,ActivaImpresion);delay_ms(10);
            write_eeprom(41,timpresion);delay_ms(10);
         }      
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      ...
      if(visual==1)
      {
         ...
         if(LEFT)//Si oprime boton de Toma.
         {
            delay_ms(700);Menu=6;glcd_fillscreen(OFF);Opcion=1;visual=1;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------    
   ...
   {                      
      ...
      displayTiempo(Testerilizacion[3],36,0,0,1);displayTiempo(Testerilizacion[2],42,0,0,1);
      strcpy(Menus.Letra,":");displayMenu(Menus.Letra,48,0,2,1); 
      displayTiempo(Testerilizacion[1],54,0,0,1);displayTiempo(Testerilizacion[0],60,0,0,1);
      
      // Muestra tiempo de secado actual.
      displayTiempo(Tsecado[3],36,8,0,1);displayTiempo(Tsecado[2],42,8,0,1);
      strcpy(Menus.Letra,":");displayMenu(Menus.Letra,48,8,2,1); 
      displayTiempo(Tsecado[1],54,8,0,1);displayTiempo(Tsecado[0],60,8,0,1);
      ...
      displayTiempo(Hora,84,0,3,1);
      strcpy(Menus.Letra,":");displayMenu(Menus.Letra,96,0,2,1); 
      displayTiempo(Minuto,102,0,3,1);
      
      displayTiempo(Dia,76,8,3,1);
      strcpy(Menus.Letra,"/");displayMenu(Menus.Letra,88,8,2,1); 
      displayTiempo(Mess,94,8,3,1);
      strcpy(Menus.Letra,"/");displayMenu(Menus.Letra,106,8,2,1); 
      displayTiempo(Year,112,8,3,1);
   }
