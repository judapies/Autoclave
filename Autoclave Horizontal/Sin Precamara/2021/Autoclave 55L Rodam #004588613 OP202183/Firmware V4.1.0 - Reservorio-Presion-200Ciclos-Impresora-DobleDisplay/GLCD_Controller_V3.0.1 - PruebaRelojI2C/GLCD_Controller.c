...
int8 h=0,l=0,Ajuste=0,Ajusten=0,MediaMovil=20,TTrampa=0,PantallaPrincipal=0,TipoClave=0,Modulo=0,Digito=0,yy=0,cicloVisto=0,cicloVisualizado=0,j=0,codigoAlarma=0,codigoAnt=0;
int16 posicionDato=0;
