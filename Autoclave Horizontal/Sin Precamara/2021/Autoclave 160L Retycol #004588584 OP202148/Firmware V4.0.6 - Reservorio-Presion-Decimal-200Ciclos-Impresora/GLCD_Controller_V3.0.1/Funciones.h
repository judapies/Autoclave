...
//Lectura EEPROM//--------------------------
   ...
   delay_ms(10);
   tsecados=make16(read_eeprom(48),read_eeprom(47));
   delay_ms(10);
...
void LimitaValores(){
   ...
   if(tsecados>1000 || tsecados<50){
      tsecados=50;write_eeprom(47,50);delay_ms(10);write_eeprom(48,0);delay_ms(10);
   }
}
...
void CalientaChaqueta(int16 tiempo){
