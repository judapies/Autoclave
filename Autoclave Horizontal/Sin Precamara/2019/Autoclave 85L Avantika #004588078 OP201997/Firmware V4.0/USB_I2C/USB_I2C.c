...
char const texto[16][20]={"NO ENVUELTO","ENVUELTO","DEL. NO ENVUELTO","DEL. ENVUELTO","LIQUIDOS A","LIQUIDOS B","LIQUIDOS C","SOLIDOS A","SOLIDOS B","DESINFECCION","LIBRE 1","LIBRE 2","LIBRE 3","LIBRE 4","LIBRE 5","LIBRE 6"};
...
void Lee_Vector(void){
   ...
   PresionCamara=make16((int8)rxbuf[3],(int8)rxbuf[2]);
...
if(usb_enumerated())
{
   ...
   recbuf[15]=make8(CiclosTotales,0);
   recbuf[16]=make8(CiclosTotales,1);
   recbuf[17]=Ciclo;
   recbuf[18]=Imprime;
