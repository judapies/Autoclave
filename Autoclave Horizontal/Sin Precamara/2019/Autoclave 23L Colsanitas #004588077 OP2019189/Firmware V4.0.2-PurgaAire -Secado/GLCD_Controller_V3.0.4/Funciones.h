...
//-------------------------------Control de Calentamiento------------------------------------------------------------//         
   ...
   if(error>1.0 && error<20 && Aumento<0.3)
   {
      if(Tpulso<4.0)
      {
         flagTC=1;
...
//Lectura EEPROM//--------------------------
   ...
   delay_ms(10);
   sg2=read_eeprom(45);
   tsecados=make16(read_eeprom(47),read_eeprom(46));
   delay_ms(10);
...
void LimitaValores(){
   ...
   if(tsecados>1000 || tsecados<50){
      tsecados=750;write_eeprom(46,0xee);delay_ms(10);write_eeprom(47,0x02);delay_ms(10);
   }
}
