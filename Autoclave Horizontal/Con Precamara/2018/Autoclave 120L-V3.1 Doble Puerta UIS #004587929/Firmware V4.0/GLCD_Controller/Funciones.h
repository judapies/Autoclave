...
float LeerPT100(int media)
{
   ...
   V0 = V0/154.6; // Se elimina la ganancia
   AN=1023*(R8+R9);
   BN=(V0*(R8+R9))+(1023*R9);
   Pt=(R10/((AN/BN)-1))-R7;
...
void Carga_Vector(void){
   ...
   SlaveA0Tx[21]=Testerilizacion[0];
   SlaveA0Tx[22]=Testerilizacion[1];
   SlaveA0Tx[23]=Testerilizacion[2];
   SlaveA0Tx[24]=Testerilizacion[3];
   SlaveA0Tx[25]=Tsecado[0];
   SlaveA0Tx[26]=Tsecado[1];
   SlaveA0Tx[27]=Tsecado[2];
   SlaveA0Tx[28]=Tsecado[3];
   SlaveA0Tx[29]=Setpoint;
   SlaveA0Tx[30]=Alarma;
   SlaveA0Tx[31]=255;
   SlaveA0Tx[32]=128;
   SlaveA0Tx[33]=50;
...
//Lectura EEPROM//--------------------------
   ...
   sg2=read_eeprom(45);
   delay_ms(10);
   openEsteril=read_eeprom(46);
   delay_ms(10);
   openContaminado=read_eeprom(47);
   delay_ms(10);
   esterilizo=read_eeprom(48);
}
