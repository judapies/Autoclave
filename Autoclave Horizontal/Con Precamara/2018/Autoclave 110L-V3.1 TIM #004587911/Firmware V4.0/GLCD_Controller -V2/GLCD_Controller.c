...
int16 tiempos=0,tiempos2=0,tiempos3=0,tiempoctrl=0,Nivel=0,tinicio=0,PresionCamara=0,PresionPreCamara=0,Ciclos=0,NivelSeleccionado=0,tStop=0,tTermostato=0;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      if(Menu==6){ // Menu de Prueba de Componentes
         ...
         if(RX_Buffer[4]==0x21)//Oprimio salir
         {
            ...
            SendDataDisplay();
            PantallaPrincipal=0;
            PruebaEstados=OFF;Desfogue_off;AguaIn_off;SSR_off;SSR2_off;
            ApagaSalidas();
            // Falta apagar Todo
         }
     }
