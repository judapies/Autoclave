...
short AlarmaBomba=OFF,guardaCiclo=OFF,Cilindro=OFF,AlarmaLlenado=OFF,cerroSucio=OFF,cerroLimpio=OFF,pulsoSubirS=OFF,pulsoSubirL=OFF,vacioEmpaqueL=OFF,vacioEmpaqueS=OFF,abrirPuertaL=OFF;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
   if(Menu==240){ //Menu de Bienvenida.
      ...
      printf("page Clave");
      SendDataDisplay();
   }else if(Menu==20){ // Este es el menu de cuando el proceso se inicio.
...
}else if(Menu==100){ //Menu de Configuración de Parametros de Control
