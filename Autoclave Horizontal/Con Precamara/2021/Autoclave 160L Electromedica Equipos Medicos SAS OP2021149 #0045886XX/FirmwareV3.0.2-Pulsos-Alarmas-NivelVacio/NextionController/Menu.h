void menuPrincipal(){
   if(Menu==240){ //Menu de Bienvenida.
      ...
      */
      if(RX_Buffer[6]==0x02){//02, Imprime
         RX_Buffer[6]=0x00;  
         RX_Buffer2[6]=0x00;
   ...
   */
   ...
   if(Grafica==1){
      printf("add 12,0,%1.0f",Temperatura*0.66666);
      SendDataDisplay();
      printf("add 12,1,%1.0f",PresionCamara*0.66666);
      SendDataDisplay();
      printf("add 12,2,%1.0f",PresionPreCamara*0.66666);
      SendDataDisplay();
      Grafica=0;
   }
