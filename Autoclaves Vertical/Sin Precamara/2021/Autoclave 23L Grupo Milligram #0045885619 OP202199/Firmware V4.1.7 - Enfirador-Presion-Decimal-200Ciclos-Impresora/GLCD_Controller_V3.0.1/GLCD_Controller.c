...
//Banderas//--------------------
short IniciaLlenado=OFF,CalderinLleno=OFF,IniciaCiclo=OFF,Esterilizando=OFF,Secando=OFF,SensadoNivel=OFF,Desfogando=OFF,DesfogueSuave=OFF,purgo=OFF,purgaAire2=OFF,borra=OFF;
...
int16 t_exhaust=0,tbuzzer=0,tsilencio=0,tiempoAgua=0,tStop=0,tTermostato=0,cicloVisto=0,cicloVisualizado=0,posicionDato=0,i=0,j=0;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
   if(Menu==12){//Menu de Visualizacion de Ciclos Realizados
      ...
      */      
      ...
      printf("t0.txt=\"Ciclo %03Lu\"",cicloVisto);
      SendDataDisplay();
