...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------    
   ...
   {      
      ...
      {
         ControlaPresion();
         if(PresionCamara16>=(Atmosferica-35) && PulsoPositivo==10)
         {
            Bomba_on;
            EV_Bomba_on;
            EV_AireBomba_off;
      ...
      if(EVDesfogue==1 ) // Desfogue Rapido
      {
         EV_Bomba_off;
         EV_AireBomba_off;
         EV_Aire_off;
      ...
      {
         if(PresionCamara16>=(Atmosferica-30))
         {
            Bomba_on;
            EV_Bomba_on;
            EV_AireBomba_off;
         ...
         if(PresionCamara16<=(Atmosferica-35))
         {
            Bomba_on;
            EV_Bomba_off;
            EV_AireBomba_on;
