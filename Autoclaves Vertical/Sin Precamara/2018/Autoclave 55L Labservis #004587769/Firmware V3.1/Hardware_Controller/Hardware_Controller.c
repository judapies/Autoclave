...
float V0=0.0,R1=6150.0,Pt,Tciclo=10.0,Tpulso=0.0,error=0.0,Prom=0.0,Temperature=0.0,tmp=0.0,Ganancia=25.0,Ganancia2=20.0,desvio=0.0,d3=0.0,d4=0.0,d5=0.0;
...
float Leer_Sensor(int media)
{
   ...
   V0 = V0/41.36; // Se elimina la ganancia
