...
float LeerPT100(int media)
{
   ...
   V0 = V0/103.19; // Se elimina la ganancia
   //V0 += 14.82;
   V0 += 14.80; //72.8mV VCC:5.030
   Pt=R10/((1023/V0)-1);
...
void Carga_Vector(void){
   ...
   SlaveA0Tx[4]=make8(PresionCamara,0);
   SlaveA0Tx[5]=make8(PresionCamara,1);
   SlaveA0Tx[2]=make8(PresionPreCamara,0);
   SlaveA0Tx[3]=make8(PresionPreCamara,1);
