...
short flagBuzzer=OFF,flagSilencio=OFF,Finalizo=OFF,AlarmaPresion=OFF,Libre=OFF,purga=OFF,entro=OFF,purgo=OFF,purgaAire2=OFF;

//Tiempos//---------------------
int16 TiempoCiclo=0,TiempoLlenado=0,TiempoSensadoNivel=0,Tp=0,Tc=0,tPurgaAire=0;
...
int16 t_exhaust=0,tbuzzer=0,tsilencio=0,tStop=0,tTermostato=0;
...
char const texto[9][20]={"LIQUIDOS A","CAUCHO","INSTRUMENTAL","LIQUIDOS B","LIBRE","TEST","HORA Y FECHA","CLAVE"};
