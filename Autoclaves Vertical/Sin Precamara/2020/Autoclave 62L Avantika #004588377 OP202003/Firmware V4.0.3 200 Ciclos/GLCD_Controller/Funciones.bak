...
float LeerPT100(int media)
{
   ...
   V0 = V0/106.61; // Se elimina la ganancia
   //V0 += 14.82;
   V0 += 14.83; //73.2mV VCC:5.049
   Pt=R10/((1023/V0)-1);
   ...
   Temperature+=((float)(Ajuste/10.0)-(float)(Ajusten/10.0));
   //Temperature-=39.0;
...
void GuardaDatoCiclo(){
   ...
   if(!Ciclo){
      ...
      delay_ms(10);
      write_ext_eeprom(6+(cicloMemoria*320)+(posicionDato*9),extraeDecima(Temperatura));
      delay_ms(10);
