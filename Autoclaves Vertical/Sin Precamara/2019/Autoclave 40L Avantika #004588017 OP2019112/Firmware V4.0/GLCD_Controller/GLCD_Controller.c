...
float V0=0.0,R1=6200.0,Pt,Tciclo=10.0,Tpulso=0.0,error=0.0,Prom=0.0,Temperature=0.0,tmp=0.0,Ganancia=25.0,Ganancia2=20.0,desvio=2.0;
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      if(UP){
         if(Flanco == 0){
            Flanco = 1;delay_ms(1);Opcion--;visual=1;
         }
      }else{
         Flanco = 0;
      }
      ...
      if(DOWN){
         if(Flanco2 == 0){
            Flanco2 = 1;delay_ms(1);Opcion++;visual=1;
         }     
      }else{
         Flanco2 = 0;
      }
       ...
       if(RIGHT)//Si oprime SET
         {  if(Flanco1 == 0) 
               {Flanco1 = 1;delay_ms(3);Menu=Opcion+3;Opcion=1;glcd_fillscreen(OFF);visual=1;
               }
         }
            else
               {Flanco1 = 0;}  
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      ...
      if(visual==1)
      {
         ...
         {
            delay_ms(700);Menu=8;glcd_fillscreen(OFF);Opcion=1;visual=1;
            write_eeprom(4,Tsecadop[0]);delay_ms(20);write_eeprom(5,Tsecadop[1]);delay_ms(20);
            write_eeprom(6,Tsecadop[2]);delay_ms(20);write_eeprom(7,Tsecadop[3]);delay_ms(20);
         }
     }
//_--------------------------------------------------------------------------------------------------------------------------------------------------------    
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      ...
      if(visual==1)
      {
         ...
         {
            delay_ms(700);Menu=8;glcd_fillscreen(OFF);Opcion=1;visual=1;
            write_eeprom(8,Setpoint);delay_ms(20);
         }
     }
//_--------------------------------------------------------------------------------------------------------------------------------------------------------    
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
      ...
      if(Opcion<=6){
         ...
         {  
            delay_ms(10);
            if(Flanco1 == 0)
               {Flanco1 = 1;delay_ms(1);Menu=Opcion+100;Opcion=1;glcd_fillscreen(OFF);visual=1;
               }
         }
            else
               {Flanco1 = 0;} 
...
//_--------------------------------------------------------------------------------------------------------------------------------------------------------
 ...
 //_--------------------------------------------------------------------------------------------------------------------------------------------------------      
      if(Menu==211){ // Menu de Ciclos
         ...
         //char v[9];
         //sprintf(v, "%05Lu", Ciclos); 
         //glcd_rect(x, y, x+(tamano*12), y+(tamano*7), YES, OFF);
         //glcd_text57(x+1, y+1, v, tamano, ON);
